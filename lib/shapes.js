...
class Square extends SVGBase {
    renderSquare = (shapeColor, text, textColor) => {
        ...
        <rect x="" y="" width="300" height="300" fill="${shapeColor}"/>

        <text x="150" y="175" font-size="100" fill="${textColor}" text-anchor="middle" >${text}</text>
...
class Circle extends SVGBase {
    renderCircle = (shapeColor, text, textColor) => {
        ...
        <text x="155" y="175" font-size="100" fill="${textColor}" text-anchor="middle" >${text}</text>
...
class Triangle extends SVGBase {
    renderTriangle = (shapeColor, text, textColor) => {
        ...
        <text x="150" y="275" font-size="115" fill="${textColor}" text-anchor="middle" >${text}</text>
